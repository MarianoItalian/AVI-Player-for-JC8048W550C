...
// I2S piny dla JC8048W550C
#define I2S_BCLK  0
#define I2S_LRCK  18
#define I2S_DOUT  17
#define I2S_DIN   -1
#define I2S_MCLK  -1   // brak MCLK na tej płytce

extern float volumeLevel;
#define I2S_DEFAULT_GAIN_LEVEL  volumeLevel
...
esp_err_t i2s_init()
{
  ...
  pin_config.mck_io_num = I2S_PIN_NO_CHANGE;  // brak MCLK
